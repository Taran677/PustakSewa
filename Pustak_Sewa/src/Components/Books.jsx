...
export default function Books({ books, setBook }) {
  ...
  return (
    <>
      ...
      <div
        ref={scrollRef}
        className="bookCollection flex sm:flex-row px-5 py-10 h-5/6 justify-evenly overflow-x-scroll flex-nowrap items-stretch relative"
      >
        <button
          onClick={handlescrollleft}
          className="btnscrollleft p-2 flex items-center justify-center rounded-full sticky w-10 h-10 z-50 bg-purple-500 text-white lg:left-5 translate-y-48 sm:left-2 left-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
