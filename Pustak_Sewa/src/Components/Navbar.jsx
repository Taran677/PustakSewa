...
export default function Navbar({ books, setBooks, setLoading, setError }) {
  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center xs:flex-row flex-col">
        <div
        ...
        >
          ...
          <span className="flex px-2 justify-center min-w-max items-center">Pustak Sewa</span>
        </div>
